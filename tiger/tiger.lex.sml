...
fun yyAction47 (strm, lastMatch : yymatch) = (yystrm := strm;
      (inString := true; stringBuf := ""; stringStart := yypos; YYBEGIN STRING; continue()))
fun yyAction48 (strm, lastMatch : yymatch) = (yystrm := strm;
      (inString := true; YYBEGIN INITIAL; Tokens.STRING(!stringBuf, !stringStart, yypos+1)))
       ...
       of NONE => yyAction41(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction41(strm, yyNO_MATCH)
                  else yyQ77(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ39(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
              else yyAction41(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction41(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction41(strm, yyNO_MATCH)
                  else yyQ81(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ39(strm', yyMATCH(strm, yyAction41, yyNO_MATCH))
              else yyAction41(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ20 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction19(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ83(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
       ...
       of NONE => yyAction17(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ84(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
...
fun yyQ16 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction4(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ86(strm', yyMATCH(strm, yyAction4, yyNO_MATCH))
...
fun yyQ14 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction14(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ88(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
